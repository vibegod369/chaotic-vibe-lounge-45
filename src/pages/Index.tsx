        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className={`max-w-3xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              ...
              <Button variant="outline" className="border-vibe-pink text-vibe-pink hover:bg-vibe-pink/20 href="https://chatgpt.com/canvas/shared/67ee88be82248191be43be691f900a7b.
                Read Whitepaper
              </Button>
            </div>
